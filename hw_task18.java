...
public class hw_task18 {
   public static void main(String[] args) {
      ...
      Notebook notebook2 = new Notebook("Acer", "4", "1000", "Windows", "black");
      Notebook notebook3 = new Notebook("Asus", "4", "2000", "Lunex", "black");
      Notebook notebook4 = new Notebook("HP", "16", "1000", "Windows", "grey");
      Notebook notebook5 = new Notebook("Honor", "8", "1000", "Windows", "black");
   ...
   public static Map<String, String> selectCriteria() {
      ...
      while (true) {
         System.out.println("Вы хотите выбрать критерий? 1 - да, 2 - нет");
